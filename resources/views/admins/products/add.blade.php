            ...
            <form enctype="multipart/form-data" class="column" action="{{ url()->to('admins/post/add/product/process') }}" method="POST" onsubmit="PostRequest(event,this,MyFunc.CallBack)">
              <input type="hidden" name="_token" class="input" value="{{ csrf_token() }}">
                ...
                <div class="cont required">
                    <input type="text" placeholder="E.g Bronze Product" name="name" class="inp input required">
                ...
                <div class="cont required">
                    <input type="number" step="any" placeholder="E.g 100000" name="price" class="inp input required">
                     @include('components.sections',[
                        'required' => 'true'
                    ])
                </div>
                ...
                <div class="cont required">
                    <input type="number" step="any" placeholder="E.g 500" name="return" class="inp input required">
                     @include('components.sections',[
                        'required' => 'true'
                    ])
                </div>
                ...
                <div class="cont required">
                    <input type="number" placeholder="E.g 25" name="validity" class="inp input required">
                     @include('components.sections',[
                        'required' => 'true'
                    ])
                </div>
                ...
                <div class="cont required">
                    <input value="10000" type="number" placeholder="E.g 25" name="limit" class="inp input required">
                     @include('components.sections',[
                        'required' => 'true'
                    ])
                </div>

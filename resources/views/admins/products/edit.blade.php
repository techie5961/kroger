        ...
        <div class="column p-10 bg-light w-full br-10 g-10">
            ...
            <form enctype="multipart/form-data" class="column" action="{{ url()->to('admins/post/edit/product/process') }}" method="POST" onsubmit="PostRequest(event,this,MyFunc.CallBack)">
             <input type="hidden" value="{{ $product->id }}" name="id" class="input">
                ...
                <label style="background-image: url('{{ asset('products/'.$product->photo.'') }}')" for="photo" class="br-20 max-w-200 pointer clip-20 column justify-center c-primary m-x-auto w-half border-dashed-2 perfect-square  bg-image">
